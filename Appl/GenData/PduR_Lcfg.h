 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: PduR_Lcfg.h
 *   Generation Time: 2025-03-02 23:14:14
...
#define PDUR_LOCKROMIDXOFBMTXBUFFERINDROM                             STD_OFF  /**< Deactivateable: 'PduR_BmTxBufferIndRom.LockRomIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_LOCKROMUSEDOFBMTXBUFFERINDROM                            STD_OFF  /**< Deactivateable: 'PduR_BmTxBufferIndRom.LockRomUsed' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_COREID2COREMANAGERROM                                    STD_OFF  /**< Deactivateable: 'PduR_CoreId2CoreManagerRom' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_COREMANAGERROMIDXOFCOREID2COREMANAGERROM                 STD_OFF  /**< Deactivateable: 'PduR_CoreId2CoreManagerRom.CoreManagerRomIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_COREMANAGERROMUSEDOFCOREID2COREMANAGERROM                STD_OFF  /**< Deactivateable: 'PduR_CoreId2CoreManagerRom.CoreManagerRomUsed' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_INVALIDHNDOFCOREID2COREMANAGERROM                        STD_OFF  /**< Deactivateable: 'PduR_CoreId2CoreManagerRom.InvalidHnd' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_COREMANAGERROM                                           STD_OFF  /**< Deactivateable: 'PduR_CoreManagerRom' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_MMROMINDENDIDXOFCOREMANAGERROM                           STD_OFF  /**< Deactivateable: 'PduR_CoreManagerRom.MmRomIndEndIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_MMROMINDSTARTIDXOFCOREMANAGERROM                         STD_OFF  /**< Deactivateable: 'PduR_CoreManagerRom.MmRomIndStartIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_MMROMINDUSEDOFCOREMANAGERROM                             STD_OFF  /**< Deactivateable: 'PduR_CoreManagerRom.MmRomIndUsed' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_SRCCOREROMENDIDXOFCOREMANAGERROM                         STD_OFF  /**< Deactivateable: 'PduR_CoreManagerRom.SrcCoreRomEndIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_SRCCOREROMSTARTIDXOFCOREMANAGERROM                       STD_OFF  /**< Deactivateable: 'PduR_CoreManagerRom.SrcCoreRomStartIdx' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_FCTPTROFFM_ACTIVATENEXT_FMSMSTATEHANDLER                 STD_OFF  /**< Deactivateable: 'PduR_Fm_ActivateNext_FmSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FM_ACTIVATEREAD_FMSMSTATEHANDLER                         STD_OFF  /**< Deactivateable: 'PduR_Fm_ActivateRead_FmSmStateHandler' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FCTPTROFFM_ACTIVATEREAD_FMSMSTATEHANDLER                 STD_OFF  /**< Deactivateable: 'PduR_Fm_ActivateRead_FmSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FM_ACTIVATEWRITE_FMSMSTATEHANDLER                        STD_OFF  /**< Deactivateable: 'PduR_Fm_ActivateWrite_FmSmStateHandler' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FCTPTROFFM_ACTIVATEWRITE_FMSMSTATEHANDLER                STD_OFF  /**< Deactivateable: 'PduR_Fm_ActivateWrite_FmSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FM_FINISHREAD_FMSMSTATEHANDLER                           STD_OFF  /**< Deactivateable: 'PduR_Fm_FinishRead_FmSmStateHandler' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FCTPTROFFM_FINISHREAD_FMSMSTATEHANDLER                   STD_OFF  /**< Deactivateable: 'PduR_Fm_FinishRead_FmSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FM_FINISHWRITE_FMSMSTATEHANDLER                          STD_OFF  /**< Deactivateable: 'PduR_Fm_FinishWrite_FmSmStateHandler' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FCTPTROFFM_FINISHWRITE_FMSMSTATEHANDLER                  STD_OFF  /**< Deactivateable: 'PduR_Fm_FinishWrite_FmSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FM_FLUSHFIFOELEMENT_FMSMSTATEHANDLER                     STD_OFF  /**< Deactivateable: 'PduR_Fm_FlushFifoElement_FmSmStateHandler' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FCTPTROFFM_FLUSHFIFOELEMENT_FMSMSTATEHANDLER             STD_OFF  /**< Deactivateable: 'PduR_Fm_FlushFifoElement_FmSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FM_TPDISABLEROUTING_FMSMSTATEHANDLER                     STD_OFF  /**< Deactivateable: 'PduR_Fm_TpDisableRouting_FmSmStateHandler' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FCTPTROFFM_TPDISABLEROUTING_FMSMSTATEHANDLER             STD_OFF  /**< Deactivateable: 'PduR_Fm_TpDisableRouting_FmSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_GENERALPROPERTIESROM                                     STD_OFF  /**< Deactivateable: 'PduR_GeneralPropertiesRom' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_HASIFTXFIFOOFGENERALPROPERTIESROM                        STD_OFF  /**< Deactivateable: 'PduR_GeneralPropertiesRom.hasIfTxFifo' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_HASTPTXBUFFEREDFORWARDINGOFGENERALPROPERTIESROM          STD_OFF  /**< Deactivateable: 'PduR_GeneralPropertiesRom.hasTpTxBufferedForwarding' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_COREMANAGERROMIDXOFMMROM                                 STD_OFF  /**< Deactivateable: 'PduR_MmRom.CoreManagerRomIdx' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_RMBUFFEREDIFPROPERTIESRAM                                STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRam' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_IFSMSTATEOFRMBUFFEREDIFPROPERTIESRAM                     STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRam.IfSmState' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_RMBUFFEREDIFPROPERTIESROM                                STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_BMTXBUFFERINDROMENDIDXOFRMBUFFEREDIFPROPERTIESROM        STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.BmTxBufferIndRomEndIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_BMTXBUFFERINDROMLENGTHOFRMBUFFEREDIFPROPERTIESROM        STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.BmTxBufferIndRomLength' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_BMTXBUFFERINDROMSTARTIDXOFRMBUFFEREDIFPROPERTIESROM      STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.BmTxBufferIndRomStartIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_DEDICATEDTXBUFFEROFRMBUFFEREDIFPROPERTIESROM             STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.DedicatedTxBuffer' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FIFOINITVALUESENDIDXOFRMBUFFEREDIFPROPERTIESROM          STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.FiFoInitValuesEndIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FIFOINITVALUESLENGTHOFRMBUFFEREDIFPROPERTIESROM          STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.FiFoInitValuesLength' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FIFOINITVALUESSTARTIDXOFRMBUFFEREDIFPROPERTIESROM        STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.FiFoInitValuesStartIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FIFOINITVALUESUSEDOFRMBUFFEREDIFPROPERTIESROM            STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.FiFoInitValuesUsed' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_FIFOTYPEOFRMBUFFEREDIFPROPERTIESROM                      STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.FifoType' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_MAXPDULENGTHOFRMBUFFEREDIFPROPERTIESROM                  STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.MaxPduLength' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_RMBUFFEREDIFPROPERTIESROMIDXOFRMGDESTROM                 STD_OFF  /**< Deactivateable: 'PduR_RmGDestRom.RmBufferedIfPropertiesRomIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_RMBUFFEREDIFPROPERTIESROMUSEDOFRMGDESTROM                STD_OFF  /**< Deactivateable: 'PduR_RmGDestRom.RmBufferedIfPropertiesRomUsed' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_FCTPTROFRMIF_FIFOHANDLING_STATEHANDLER                   STD_OFF  /**< Deactivateable: 'PduR_RmIf_FifoHandling_StateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_FCTPTROFRMIF_TXCONFIRMATION_STATEHANDLER                 STD_OFF  /**< Deactivateable: 'PduR_RmIf_TxConfirmation_StateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_FCTPTROFRMTP_CANCELRECEIVE_TPRXSMSTATEHANDLER            STD_OFF  /**< Deactivateable: 'PduR_RmTp_CancelReceive_TpRxSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_FCTPTROFRMTP_CHECKREADY2TRANSMIT_TPTXSMSTATEHANDLER      STD_OFF  /**< Deactivateable: 'PduR_RmTp_CheckReady2Transmit_TpTxSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_FCTPTROFRMTP_COPYRXDATA_TPRXSMSTATEHANDLER               STD_OFF  /**< Deactivateable: 'PduR_RmTp_CopyRxData_TpRxSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_FCTPTROFRMTP_FINISHRECEPTION_TPTXSMSTATEHANDLER          STD_OFF  /**< Deactivateable: 'PduR_RmTp_FinishReception_TpTxSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_FCTPTROFRMTP_FINISHTRANSMISSION_TPTXSMSTATEHANDLER       STD_OFF  /**< Deactivateable: 'PduR_RmTp_FinishTransmission_TpTxSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_FCTPTROFRMTP_STARTOFRECEPTION_TPRXSMSTATEHANDLER         STD_OFF  /**< Deactivateable: 'PduR_RmTp_StartOfReception_TpRxSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_FCTPTROFRMTP_TPRXINDICATION_TPRXSMSTATEHANDLER           STD_OFF  /**< Deactivateable: 'PduR_RmTp_TpRxIndication_TpRxSmStateHandler.FctPtr' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_RMTRANSMITFCTPTR                                         STD_ON
#define PDUR_RMTXINSTSMROM                                            STD_OFF  /**< Deactivateable: 'PduR_RmTxInstSmRom' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_PDUR_RMTP_TXINST_CANCELTRANSMITOFRMTXINSTSMROM           STD_OFF  /**< Deactivateable: 'PduR_RmTxInstSmRom.PduR_RmTp_TxInst_CancelTransmit' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_PDUR_RMTP_TXINST_COPYTXDATAOFRMTXINSTSMROM               STD_OFF  /**< Deactivateable: 'PduR_RmTxInstSmRom.PduR_RmTp_TxInst_CopyTxData' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_PDUR_RMTP_TXINST_TRIGGERTRANSMITOFRMTXINSTSMROM          STD_OFF  /**< Deactivateable: 'PduR_RmTxInstSmRom.PduR_RmTp_TxInst_TriggerTransmit' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_PDUR_RMTP_TXINST_TXCONFIRMATIONOFRMTXINSTSMROM           STD_OFF  /**< Deactivateable: 'PduR_RmTxInstSmRom.PduR_RmTp_TxInst_TxConfirmation' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_SRCCOREROM                                               STD_OFF  /**< Deactivateable: 'PduR_SrcCoreRom' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_DEFERREDEVENTCACHEROMIDXOFSRCCOREROM                     STD_OFF  /**< Deactivateable: 'PduR_SrcCoreRom.DeferredEventCacheRomIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_DEFERREDEVENTCACHEROMUSEDOFSRCCOREROM                    STD_OFF  /**< Deactivateable: 'PduR_SrcCoreRom.DeferredEventCacheRomUsed' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_MCQBUFFERROMIDXOFSRCCOREROM                              STD_OFF  /**< Deactivateable: 'PduR_SrcCoreRom.McQBufferRomIdx' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_MCQBUFFERROMUSEDOFSRCCOREROM                             STD_OFF  /**< Deactivateable: 'PduR_SrcCoreRom.McQBufferRomUsed' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PDUR_EXISTS_NO_BUFFER_FIFOTYPEOFRMBUFFEREDIFPROPERTIESROM     STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.FifoType' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_EXISTS_T_T_SINGLE_BUFFER_FIFOTYPEOFRMBUFFEREDIFPROPERTIESROM STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.FifoType' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_EXISTS_T_T_FIFO_BUFFER_FIFOTYPEOFRMBUFFEREDIFPROPERTIESROM STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.FifoType' Reason: 'The PDUR gateway is not Licensed.' */
#define PDUR_EXISTS_DIRECT_FIFO_BUFFER_FIFOTYPEOFRMBUFFEREDIFPROPERTIESROM STD_OFF  /**< Deactivateable: 'PduR_RmBufferedIfPropertiesRom.FifoType' Reason: 'The PDUR gateway is not Licensed.' */
...
#define PduR_GetSizeOfRmDestRomOfPCConfig()                           7u  /**< the number of accomplishable value elements in PduR_RmDestRom */
#define PduR_GetSizeOfRmGDestRomOfPCConfig()                          7u  /**< the number of accomplishable value elements in PduR_RmGDestRom */
#define PduR_GetSizeOfRmSrcRomOfPCConfig()                            7u  /**< the number of accomplishable value elements in PduR_RmSrcRom */
...
#define PduR_GetSizeOfTx2LoOfPCConfig()                               4u  /**< the number of accomplishable value elements in PduR_Tx2Lo */
#define PduR_GetSizeOfTxIf2UpOfPCConfig()                             3u  /**< the number of accomplishable value elements in PduR_TxIf2Up */
...
#define PduR_GetRmSrcRomIdxOfRxTp2Dest(Index)                         ((PduR_RmSrcRomIdxOfRxTp2DestType)((((PduR_RmSrcRomIdxOfRxTp2DestType)(Index)) + 1u)))  /**< the index of the 0:1 relation pointing to PduR_RmSrcRom */
...
#define PduR_GetRmGDestRomIdxOfTxTp2Src(Index)                        ((PduR_RmGDestRomIdxOfTxTp2SrcType)((((PduR_RmGDestRomIdxOfTxTp2SrcType)(Index)) + 3u)))  /**< the index of the 1:1 relation pointing to PduR_RmGDestRom */
/** 
  \}
*/ 
